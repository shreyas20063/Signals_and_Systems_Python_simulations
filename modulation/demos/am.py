...
from styles import (COLORS, VALUE_LABEL_STYLE, make_label, style_slider, style_spinbox, style_button)
...
class DemoWindowAM(DemoWindowBase):
    ...
    def _load_audio(self) -> None:
        self.original_sr, audio = load_and_validate_audio("audio_sample.wav")
