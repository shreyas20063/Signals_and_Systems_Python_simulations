"""
Main window for the Feedback Amplifier Simulator
...
class FeedbackAmplifierWindow(QMainWindow):
    """Main window for the interactive feedback amplifier simulator"""

    def __init__(self):
        super().__init__()
        self.setWindowTitle('Feedback Amplifier Simulator')
