"""
Second-order system modelling utilities for the interactive frequency response simulator.
...
@dataclass
class SecondOrderSystemParameters:
...
class SystemCharacteristics:
    """Computed properties of the second-order system."""
...
def build_transfer_function(params: SecondOrderSystemParameters) -> signal.TransferFunction:
    """Return the continuous-time transfer function H(s) for the second-order system."""
    num = [params.omega_0**2]
    den = [1.0, params.omega_0 / params.Q, params.omega_0**2]
    return signal.TransferFunction(num, den)


def analyze_system(params: SecondOrderSystemParameters) -> SystemCharacteristics:
