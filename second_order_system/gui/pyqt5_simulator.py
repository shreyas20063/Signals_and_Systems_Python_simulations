"""
PyQt5-based interactive GUI controller for the Second-Order System frequency response simulator.
...
class SecondOrderSystemSimulator(QMainWindow):
    """PyQt5-based facade that wires together the model computations and plotting helpers."""

    def __init__(self) -> None:
        super().__init__()
        self.params = SecondOrderSystemParameters()
        self._init_ui()
        self.update_plot()

    def _init_ui(self) -> None:
        """Initialize the PyQt5 user interface."""
        self.setWindowTitle("Second-Order System Response Simulator")
...
def launch_simulator() -> None:
    ...
    simulator = SecondOrderSystemSimulator()
    simulator.show()
    sys.exit(app.exec_())
