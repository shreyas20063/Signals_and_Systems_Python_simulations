"""
Interactive GUI controller for the Second-Order System frequency response simulator.
...
class SecondOrderSystemSimulator:
    ...
    def _build_figure(self) -> None:
        ...
        self.fig = plt.figure(
            "Second-Order System Response Simulator", figsize=(16, 10), constrained_layout=False
        )
        self.fig.suptitle(
